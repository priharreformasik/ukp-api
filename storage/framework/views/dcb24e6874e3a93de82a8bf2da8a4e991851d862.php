...
<!--             <li><a href="<?php echo e(url('data/tes')); ?>"><i class="fa fa-circle-o"></i> Jenis Tes & Tarif</a></li>
 -->            <li><a href="<?php echo e(url('data/kategori')); ?>"><i class="fa fa-circle-o"></i> Kategori Klien</a></li>
            <!-- <li><a href="<?php echo e(url('data/keahlian')); ?>"><i class="fa fa-circle-o"></i> Keahlian Psikolog</a></li> -->
