        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              ...
              <a href="<?php echo e(url('data/layanan/tambah')); ?>" type="button" class="btn btn-block btn-primary"><i class="fa fa-plus mg-r-10"></i> Tambah Layanan</a>
              </div>
            ...
            <div class="box-body" style="margin-right: 15px; margin-left: 15px;">
              <table id="datatable1" class="table table-bordered table-striped">
                <thead>
                        ...
                        <tbody> 
                        <?php $__currentLoopData = $list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $layanan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>                         
                            <tr>
                                <td align="center"><?php echo e($value+1); ?></td>
                                <td><?php echo e($layanan->nama); ?></td>
                                <td><?php echo e($layanan->deskripsi); ?></td>
                                <td>Rp <?php echo e(number_format($layanan->harga,0,".",".")); ?></td>
                                <td align="center">
                                    <div>
                                    <a href="<?php echo e(url('data/layanan/'.$layanan->id.'/edit')); ?>" class="btn btn-warning" style="border-radius:50%;" title="Edit">
                                        <div><i class="fa fa-pencil" style="margin:5px 2px 5px 2px;"></i></div>
                                    </a>
                                    <a href="<?php echo e(url('data/layanan/'.$layanan->id.'/delete')); ?>" class="btn btn-danger btn-sm"
                                       data-tr="tr_<?php echo e($layanan->id); ?>"
