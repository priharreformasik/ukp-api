            ...
            <section class="col-lg-12 connectedSortable">
              ...
              <div class="box box-success">
                <div class="box-header with-border">
                  <h3 class="box-title">Grafik Jumlah Konsultasi Berdasarkan Klien</h3>
                </div>
                {!! Form::open(array('url'=>'statistik/report_all_klien','method'=>'GET', 'files'=>'true', 'class'=>'form-horizontal'))!!}
