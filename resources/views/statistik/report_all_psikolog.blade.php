            ...
            <section class="col-lg-12 connectedSortable">
              ...
              <div class="box box-success">
                <div class="box-header with-border">
                  <h3 class="box-title">Grafik Jumlah Konsultasi Berdasarkan Psikolog</h3>
                </div>
                {!! Form::open(array('url'=>'statistik/report_all_psikolog','method'=>'GET', 'files'=>'true', 'class'=>'form-horizontal'))!!}
          ...
          <div class="box box-success">
            ...
            <div class="row mt-3" style="margin-top:20px;">
                <div class="col-lg" style="text-align: center">
                  ...
                  {!! Form::open(array('url'=>'/report_psikolog/pdf','method'=>'GET','class'=>'form-horizontal')) !!}
                  ...
                  {!! Form::open(array('url'=>'/report_psikolog/excel','method'=>'GET','class'=>'form-horizontal')) !!}
                  <!-- <input type="hidden" name="layanan" value="{{$request->layanan}}"> -->
                    <input type="hidden" name="from" value="{{$request->from}}">
                    <input type="hidden" name="until" value="{{$request->until}}">
