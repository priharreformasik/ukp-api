...
<section class="content">
  ...
  {!! Form::open(array('url'=>'statistik/psikolog_report','method'=>'POST', 'files'=>'true', 'class'=>'form-horizontal'))!!}
    <div class="box-body">
      <!-- Main row -->
      <div class="row">
        <!-- Left col -->
          ...
          <div class="box box-success">
            <div class="box-header with-border">              
              <div class="row pl-5 pr-5" style="margin-top: 5px; margin-bottom: 20px;" align="center">
                  <h4>REKAP KONSULTASI BERDASARKAN NAMA PSIKOLOG</h4>
              </div>
              <div class="row pl-5 pr-5" style="margin-right: 200px; margin-left: 200px; margin-top:15px;">
                  ...
                  <div class="col-md-8">
                    <select class="form-control select2" name="psikolog">
                        <option value="">Pilih Psikolog</option>
                        @foreach($psikolog as $value)
                            <option value="{{$value->id}}" {{collect(old('psikolog'))->contains($value->id) ? 'selected':''}}>{{$value->name}}</option>
                        @endforeach
                    </select>
                  </div>
              </div>
        ...
        {!! Form::open(array('url'=>'statistik/report_all_psikolog','method'=>'POST', 'files'=>'true', 'class'=>'form-horizontal'))!!}
        <div class="box-body">
          <!-- Main row -->
          <div class="row">
            <!-- Left col -->
            <section class="col-lg-12 connectedSortable">
              ...
              <div class="box box-success">
                <div class="box-header with-border">
              <div class="row pl-5 pr-5" style="margin-top: 5px; margin-bottom: 20px;" align="center">
                  <h4>REKAP KONSULTASI PSIKOLOG</h4>
              </div>
