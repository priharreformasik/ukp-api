          ...
          <div class="box box-success">
            <div class="box-body" style="margin-right: 15px; margin-left: 15px;">
              <div class="box-header with-border">
                  {!! Form::open(array('url'=>'statistik/klien_report','method'=>'POST', 'files'=>'true', 'class'=>'form-horizontal'))!!}
                  <input type="hidden" name="klien" value="{{$request->klien}}">
            ...
            <div class="row mt-3" style="margin-top:20px;">
                <div class="col-lg" style="text-align: center">
                  ...
                  <div class="pull-right" style="margin-left: 5px;">
                    {!! Form::open(array('url'=>'/report_perklien/pdf','method'=>'GET','class'=>'form-horizontal')) !!}
                    <input type="hidden" name="klien" value="{{$request->klien}}">
                  ...
                  {!! Form::open(array('url'=>'/report_perklien/excel','method'=>'GET','class'=>'form-horizontal')) !!}
                    <input type="hidden" name="klien" value="{{$request->klien}}">
                    <input type="hidden" name="from" value="{{$request->from}}">
                    <input type="hidden" name="until" value="{{$request->until}}">
