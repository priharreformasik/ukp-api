...
@section('content-header')
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="{{url('data/status')}}">Daftar Status</a></li>
...
@section('content')
    <section class="content">
      ...
      <div class="box box-default" style="padding-top: 30px; ">
        <!-- /.box-header -->
        {!! Form::open(array('url'=>'data/status/simpan','method'=>'POST', 'files'=>'true','class'=>'form-horizontal'))!!}
          <div class="box-body" style="padding-left: 100px; padding-right: 100px;">
            <div class="col-md-12 pl-5 pr-5">
              <div class="row pl-5 pr-5" style="margin-top: 5px;">
                  ...
                  <div class="col-md-8">
                    <input type="text" class="form-control" name="nama" placeholder="Status" value="{{old('nama')}}">
                  </div>
              </div>
          ...
          <div class="row mt-3">
                <div class="col-lg" style="text-align: center ; padding-bottom:10px;">
                  <button type="button" class="btn btn-danger" onclick="location.href='{{url('data/status')}}'">Kembali</button>
