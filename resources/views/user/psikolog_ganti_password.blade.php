...
@section('content-header')
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="{{url('user/psikolog/'.$data->id.'/edit')}}">  Edit Psikolog</a></li>
...
@section('content')
    <section class="content">
      ...
      <div class="box box-default" style="padding-top: 30px; ">
        <!-- /.box-header -->
        {!! Form::open(array('url'=>'ganti_password/'.$data->id.'/psikolog', 'method'=>'POST','enctype'=>'multipart/form-data'))!!}
