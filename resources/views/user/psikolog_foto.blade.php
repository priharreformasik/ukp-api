...
@section('content-header')
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="{{url('user/psikolog/'.$data->id.'/edit')}}">Edit Data Psikolog</a></li>
...
@section('content')
    <section class="content">
      ...
      <div class="box box-default" style="padding-top: 30px; ">
        <!-- /.box-header -->
        {!! Form::open(array('url'=>'user/psikolog/'.$data->id.'/edit_foto', 'method'=>'POST','enctype'=>'multipart/form-data'))!!}
          ...
          <div class="row mt-3">
                <div class="col-lg" style="text-align: center ; padding-bottom:10px;">
                  <button type="button" class="btn btn-danger" onclick="location.href='{{url('user/psikolog/'.$data->id.'/edit')}}'">Kembali</button>
