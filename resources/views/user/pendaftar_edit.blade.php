...
@section('content')
    <section class="content">
      ...
      <div class="box box-default">
        <!-- /.box-header -->
        {!! Form::open(array('url'=>'user/pendaftar/'.$data->id.'/edit', 'method'=>'POST','enctype'=>'multipart/form-data'))!!}
          <div class="box-body" style="padding-left: 70px; padding-right: 30px; margin-top: 50px;">
            <div class="col-md-2 pl-5 pr-5">
              ...
              <div align="center" style="margin-top: 10px;">
                <a href="{{url('user/pendaftar/'.$data->id.'/edit_foto')}}"><i class="fa fa-pencil"></i> Ganti Foto</a>
              </div>
            </div>
            <div class="col-md-10 pl-5 pr-5" style="padding-left: 50px; margin-top: 5px;">
