...
@section('content-header')
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="{{url('user/pendaftar/'.$data->id.'/edit')}}">Edit Data Keluarga Klien</a></li>
...
@section('content')
    <section class="content">
      ...
      <div class="box box-default" style="padding-top: 30px; ">
        <!-- /.box-header -->
        {!! Form::open(array('url'=>'user/pendaftar/'.$data->id.'/edit_foto', 'method'=>'POST','enctype'=>'multipart/form-data'))!!}
          ...
          <div class="row mt-3">
                <div class="col-lg" style="text-align: center ; padding-bottom:10px;">
                  <button type="button" class="btn btn-danger" onclick="location.href='{{url('user/pendaftar/'.$data->id.'/edit')}}'">Kembali</button>
