...
@section('content-header')
    <section class="content-header">
      <h1>
        Approve Jadwal Konsultasi
      </h1>
      <ol class="breadcrumb">
        <li><a href="{{url('/home')}}"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="{{url('pengaturan/aproval')}}">Pengaturan</a></li>
        <li><a href="{{url('pengaturan/aproval')}}">Approval Jadwal</a></li>
        <li class="active">Approve Jadwal Konsultasi</li>
      </ol>
    </section>
@stop
...
@section('content')
    <section class="content">
      ...
      <div class="box box-default" style="padding-top: 30px; ">
        <!-- /.box-header -->
        {!! Form::open(array('url'=>'pengaturan/aproval/'.$data->id.'/edit', 'method'=>'POST'))!!}
          <div class="box-body" style="padding-left: 100px; padding-right: 100px;">
                  ...
                  <div class="col-md-4">
                      ...
                      <div class="col-md-8">
                          <div class="input-group">
                              ...
                              <input name="tanggal" type="text" class="form-control datepicker"  placeholder="DD-MM-YYYY" data-date-format="yyyy-mm-dd" value="{{ old('tanggal') ? old('tanggal') : \Carbon\Carbon::parse($data->tanggal)->format('Y-m-d') }}">
                          </div>
                      </div>
              </div>          
              <div class="row pl-5 pr-5" style="margin-top: 5px;">
              ...
              <div class="row pl-5 pr-5" style="margin-top: 5px;" id="layanan">
                  <div class="col-md-4">
                        <p>Layanan</p>
                    </div>
                    <div class="col-md-8">
          ...
          <div class="row mt-3">
                <div class="col-lg" style="text-align: center ; padding-bottom:10px;">
                  <button type="button" class="btn btn-danger" onclick="location.href='{{url('pengaturan/aproval')}}'">Kembali</button>
