...
@section('content-header')
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="{{url('pengaturan/aproval/psikolog')}}">Aproval Psikolog</a></li>
        ...
        <form class="form-horizontal">
          ...
          <div class="row mt-3">
                <div class="col-lg" style="text-align: center">
                  <button type="button" class="btn btn-success" onclick="location.href='{{url('pengaturan/aproval/psikolog')}}'">Kembali</button>
                </div>
          </div>
          </div>              
        </form>
