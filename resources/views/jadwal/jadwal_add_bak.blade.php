          ...
          <div class="box-body" style="padding-left: 100px; padding-right: 100px;">
            <div class="col-md-12 pl-5 pr-5">
                  ...
                  <div class="col-md-4">
                      ...
                      <div class="col-md-8">
                          <div class="input-group">
                              ...
                              <input name="tanggal" type="text" class="form-control fc-datepicker" id="datepicker"  placeholder="yyyy-mm-dd" data-date-format="yyyy-mm-dd" value="{{old('tanggal')}}">
                          </div>
                      </div>
              </div>
              <div class="row pl-5 pr-5" style="margin-top: 5px;">
              ...
              <div class="row pl-5 pr-5" style="margin-top: 5px;">
                  ...
                  <div class="col-md-8">
                    <textarea class="form-control" name="keluhan" placeholder="Keluhan" value="{{old('keluhan')}}"></textarea>
                  </div>
              </div>
              <div class="row pl-5 pr-5" style="margin-top: 5px;">
                  <div class="col-md-4">
...
@section('javascript')
    ...
    <script>
      $('#layanan').on('change', function(e) {
                ...
                $.get('/api/layananPsikolog?layanan_id=' + id_layanan, function(data) {
                    console.log(data);
                    $('#psikolog').empty();
